...
import { fetcher, infiniteFetcher } from "@/utils/fetcher";
...
import useReactQueryInfinite from "@/utils/useReactQueryInfinite";
...
export default function Home() {
  ...
  const { data, isLoading, isRefetching, lastElementRef } = useReactQueryInfinite(`http://localhost:3002/posts?_sort=createdAt&_order=desc`);
